...
* [Rest Repositories](https://docs.spring.io/spring-boot/3.5.0-M3/how-to/data-access.html#howto.data-access.exposing-spring-data-repositories-as-rest)
* [Liquibase Migration](https://docs.spring.io/spring-boot/3.5.0-M3/how-to/data-initialization.html#howto.data-initialization.migration-tool.liquibase)
...
```
$ docker run --rm -p 8080:8080 RealState:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/RealState
```
